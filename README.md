...
**Status: v1 surface implemented** — JSON and ZON backends, full constraint
engine, all four union tagging modes, streaming entry points. MessagePack
and the dynamic `Value`-against-schema API are next.
